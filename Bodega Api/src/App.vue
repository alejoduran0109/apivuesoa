      ...
      <tbody>
        <tr v-for="factura_producto of factura_productos" :key="factura_producto.id">
          ...
          <td>
              ...
              <button @click="remover(factura_producto)" class="btn btn-outline-danger btn-sm">Desactivar</button>
              <button  @click="despacharP(factura_producto)" class="btn btn-outline-primary btn-sm">Despachar Tienda</button>
              <button  @click="despacharP(factura_producto)" class="btn btn-outline-warning btn-sm">Solicitar Fabrica</button>
            </td>
        </tr>
      </tbody>
    </table>
...
<script>
import FabricaProducto from './services/bodega'
